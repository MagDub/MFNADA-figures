...
% Short Horizon
b1S= bar(x_ax(1),nanmean(sgm0_SH(idx_prop)),'FaceColor',col.prop(1,:), 'FaceAlpha', 0.25, 'BarWidth',.5); 
...
set(gca,'YTick',0:0.8:6)
ylim([0 3.5])


%% Export
addpath('../../export_fig')
export_fig(['Fig_model_parameters_sgm0.tif'],'-nocrop','-r200')
