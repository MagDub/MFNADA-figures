...
ybounds = [0 105];
increment = 25;
tmp_SH=load('../../data/simulation_data/sim_prob_mod16/changing_eta/Q0_5_xi_0/mat_mean_SEM_tree_high.mat');
tmp_LH=load('../../data/simulation_data/sim_prob_mod16/changing_eta/Q0_5_xi_0.2/mat_mean_SEM_tree_high.mat'); 
