...
% Short horizon
b1S = bar(x_ax(1),nanmean(consist_SH(idx_prop)),'FaceColor',col.prop(1,:), 'FaceAlpha', 0.25, 'BarWidth',.5);
...
h = errorbar(x_ax([1 2 4 5 7 8]),...
    ...
    nanstd(consist_SH(idx_plc))./sqrt(numel(idx_plc)) nanstd(consist_LH(idx_prop))./sqrt(numel(idx_plc))...
