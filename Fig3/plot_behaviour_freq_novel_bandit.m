...
% Short Horizon
b1S= bar(x_ax(1),nanmean(pickedC_SH_perc(idx_prop)),'FaceColor',col.prop(1,:), 'FaceAlpha', 0.25, 'BarWidth',.5);
...
%% Export
addpath('../../export_fig')
export_fig(['Fig_behaviour_freq_novel_bandit.tif'],'-nocrop','-r200')
