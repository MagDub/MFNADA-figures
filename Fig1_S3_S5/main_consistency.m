...
data_SH = tmp_SH.mat_mean_SEM_consistency([2 3],2:3);
data_LH = tmp_LH.mat_mean_SEM_consistency([4 5],2:3);
...
data_SH = tmp_SH.mat_mean_SEM_consistency([1 2],2:3);
data_LH = tmp_LH.mat_mean_SEM_consistency([3 4],2:3);
...
tmp_LH=load('../../data/simulation_data/sim_prob_mod5_xi/changing_gamma/xi_0.2_tau_0.7_Q0_5/mat_mean_SEM_consistency.mat'); 
data_SH = tmp_SH.mat_mean_SEM_consistency([1 2],2:3);
data_LH = tmp_LH.mat_mean_SEM_consistency([1 2],2:3);
